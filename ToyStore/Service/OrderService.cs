...
namespace SourceCode.Service
{
    public interface IOrderService
    {
        ...
        IEnumerable<Order> GetListOrderStatistic();
    ...
    public class OrderService : IOrderService
    {
        ...
        public IEnumerable<Order> GetListOrderStatistic(DateTime from, DateTime to)
        {
            ...
            if (OrderIDs.Count() > 0)
            {
                ...
                return context.OrderRepository.GetAllData(order => OrderIDs.Contains(order.ID)).OrderByDescending(order => order.Total);

            }
            return null;
        }
        public IEnumerable<Order> GetListOrderStatistic()
        {
