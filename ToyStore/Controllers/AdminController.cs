    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                ViewBag.TotalCustomer = _userService.GetUserCount();
        ...
        public ActionResult ResetPassword(string CurrentPassword, string NewPassword)
        {
            ...
            if (userCheck != null)
            {
                try
                {
                    ...
                    _userService.ResetPassword(user.ID, hashedNewPassword);
                ...
                {
                    // Ghi log nếu có lỗi trong quá trình mã hóa hoặc lưu trữ
                    // Log.Error("Error occurred during password reset.", ex);
                    ViewBag.Message = "Đã xảy ra lỗi khi đặt lại mật khẩu. Vui lòng thử lại sau.";
                }
            }
            else
            {
            ...
            // Nếu có lỗi, trở lại trang đổi mật khẩu
            return View();
        }
