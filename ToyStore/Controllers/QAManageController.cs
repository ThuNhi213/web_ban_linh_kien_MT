...
namespace SourceCode.Controllers
{
    ...
    public class QAManageController : Controller
    {
        ...
        public ActionResult EditQuestion(int id)
        {
            ...
            var qA = _qAService.GetQAByID(id);
        ...
        [HttpPost]
        public ActionResult EditQuestion(QA qA, int page)
        {
            User user = Session["User"] as User;
            QA qa = _qAService.GetQAByID(qA.ID);
            ...
            // Bảo toàn giá trị gốc của UserAskID
            int originalUserAskID = qa.UserAskID;

            // Cập nhật chỉ nội dung câu hỏi
            qa.Question = qA.Question;

            // Khôi phục giá trị gốc của UserAskID
            qa.UserAskID = originalUserAskID;
