...
namespace SourceCode.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult ConfirmEmail(int ID)
        {
            ...
            //SentMail("Mã xác minh tài khoản SourceCode", email, "tranthu2132002@gmail.com", null, "<p>Mã xác minh của bạn: " + captcha + "<br/>Hoặc xác minh nhanh bằng cách click vào link: " + urlBase + "/User/ConfirmEmailLink/" + ID + "?Capcha=" + captcha + "</p>");

            //// Còn thiếu phần code gift ở đây

            //// Đoạn mã sau đây đã được bổ sung để thực hiện việc gift cho người dùng sau khi xác minh email.
            //User user = _userService.GetByID(ID);
            //ViewBag.Message = "EmailConfirmed";
