...
namespace SourceCode.Data
{
    ...
    {
        private ShopPhuKienEntities DbContext = new ShopPhuKienEntities();
        ...
        private GenericRepository<UsageType> usageTypeRepository;
        ...
        public GenericRepository<UsageType> UsageTypeRepository
        {
            get
            {
                if (this.usageTypeRepository == null)
                {
                    this.usageTypeRepository = new GenericRepository<UsageType>(DbContext);
                }
